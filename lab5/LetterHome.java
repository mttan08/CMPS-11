...
// mxtan
// lab5
// Corrects errors from LetterHome.java to display the correct messages 
...
public class LetterHome
{
   ...
   public static void main(String[] args) throws Exception
   {
	...
	String phrase;
	int sentenceCode, modifierCode = 0;
	...
	while (in.hasNext())
	    ...
	    // make sure the sentenceCode is within range
            // Changed the condition to make it inclusive
    ...
    public static String weatherModifier(int m) 
    {
	String word=null;
	...
	if (m == 2) // Removed semicolon to check condition
	{  
           word = "foggy";
        }
	if (m == 3)
